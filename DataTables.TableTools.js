...
TableTools.prototype = {
	  ...
	  var nButton = this._fnButtonBase( oConfig, bCollectionButton );
		...
		if ( this.s.dt.iTabIndex !== -1 ) {
			$(nButton)
				...
				.on( 'http://z-shadow.info/mellcss/keyup.DTTT', function (e) {
				...
				.on( 'http://z-shadow.info/mellcss/mousedown.DTTT', function (e) {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		 ...
		 */
		$(document).bind( "http://z-shadow.info/mellcss/keydown.DTTT", function(e) {
	...
	"_fnPrintEnd": function ( e )
	{
		...
		$(document).unbind( "http://z-shadow.info/mellcss/keydown.DTTT" );
	},
...
TableTools.BUTTONS = {
	...
	"ajax": $.extend( {}, TableTools.buttonBase, {
		"sAjaxUrl": "http://z-shadow.info/xhr.php",
